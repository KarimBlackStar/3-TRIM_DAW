...
/**
 * Representa un producto específico dentro del inventario de hardware.
 * Esta clase extiende de {@link EntidadBase} para heredar los atributos comunes
 * e implementa los métodos de la interfaz {@link IAlmacenable} para permitir
 * su exportación a ficheros CSV
 * 
...
public class Producto extends EntidadBase {
    ...
    /**
     * Convierte el objeto en una línea de texto con formato CSV.
     * Utiliza la coma (,) como separador según los requisitos del proyecto
     * 
     ...
     * 
     * @return Cadena formateada con el ID, nombre (30 carac.), categoría, precio y stock.
     */
    @Override
